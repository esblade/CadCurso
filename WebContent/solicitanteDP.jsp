...
/*
	...
	String action = new String (decode);
	
	if(id == "" || action.contains("alterar")){
		byte[] decodeL = Base64.decodeBase64(session.getAttribute("loginUsuario").toString().getBytes());
		String login = new String (decodeL);
		beanLogin.setLogin(login);
		int login_ = beanLoginDP.logado(beanLogin);
		...
		//if(cod_solicitante == null){cod_solicitante = "0";}
